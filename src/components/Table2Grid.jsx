...
export default function Table2Grid({ data, onNext }) {
  ...
  return (
    <div className="p-4">
      <div className="flex justify-between items-center mb-4">
        ...
        <button className="bg-blue-500 text-white px-3 py-2 rounded">Актуализировать товар</button>
        <button className="bg-blue-500 text-white px-3 py-2 rounded">Запросить цены</button>
        <button
