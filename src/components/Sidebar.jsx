  ...
  return (
    <div className="w-48 bg-gray-100 p-4 border-r min-h-screen">
      <ul className="space-y-2 space-x-0">
        ...
        <li className={currentStep === 1 ? "bg-orange-300 text-gray px-4 py-2 rounded" : ""}>Запрос на ТМЦ</li>
        <li className={currentStep === 2 ? "bg-orange-300 text-gray px-4 py-2 rounded" : ""}>Запрос</li>
        <li className={currentStep === 3 ? "bg-orange-300 text-gray px-4 py-2 rounded" : ""}>Доп инфомация</li>
      </ul>
    </div>
  );
}